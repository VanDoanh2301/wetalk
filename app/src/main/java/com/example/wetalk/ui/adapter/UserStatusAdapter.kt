...
import com.example.wetalk.databinding.ItemUserStatusBinding

class UserStatusAdapter(private val listener:Listener) : RecyclerView.Adapter<UserStatusAdapter.MainRecyclerViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainRecyclerViewHolder {
        val binding = ItemUserStatusBinding.inflate(
    ...
    class MainRecyclerViewHolder(private val binding: ItemUserStatusBinding):
