package com.example.wetalk.service
...
import com.example.wetalk.data.local.isValid
import com.example.wetalk.repository.FireBaseRepository
import com.example.wetalk.webrtc.RTCAudioManager
...
class MainService : Service(), FireBaseRepository.Listener {
    ...
    private val TAG = "com.example.wetalk.service.MainService"
