...
import com.example.wetalk.data.remote.FirebaseClient
import com.example.wetalk.util.UserStatus
import com.example.wetalk.webrtc.MyPeerObserver
import com.example.wetalk.webrtc.WebRTCClient
...
class FireBaseRepository @Inject constructor(
    ...
    fun login(username: String, isDone: (Boolean, String?) -> Unit) {
        firebaseClient.login(username, isDone)
    }
